...
> **历史留档（2026-09-18 复核）**：两点**均早已落地**——(1) 走了推荐路线 (a) 摘要行瘦身
> （`preselect-visibility/01-02`，全库可装 86598B → 28071B、截断消失）；(2) 骨架映射并进第 2 批，
> 验收线「每个有映射的模块至少一个词项命中参考条目标题」已写成守卫。本段保留原始提问供追溯，
> **不要再按它提问**。
