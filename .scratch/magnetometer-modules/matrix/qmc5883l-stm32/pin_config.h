...
/* HMC5883L 三轴磁力计（电子罗盘，软 I2C）：默认 PA6/PA7 = 库内软 I2C 总线
 * 共享组（地址 0x3C/0x3D 与 aht10 0x70、bh1750 0x46、sht20 0x40、sht30
 * 0x44、at24c02 0xA0、ags10 0x1A、ads1115 0x90、vl53l0x 0x52、mlx90614
 * 0x5A 全异——多挂合法），同选时经引脚绑定消解 ---- */
#define HMC5883L_SCL_GPIO     GPIO_A
#define HMC5883L_SCL_PIN      Pin_6
#define HMC5883L_SDA_GPIO     GPIO_A
#define HMC5883L_SDA_PIN      Pin_7
/* QMC5883L 三轴磁力计（电子罗盘，软 I2C）：默认 PA6/PA7 = 库内软 I2C 总线
 * 共享组（地址 0x0D/0x0E 与 aht10 0x70、bh1750 0x46、sht20 0x40、sht30
 * 0x44、at24c02 0xA0、ags10 0x1A、ads1115 0x90、vl53l0x 0x52、mlx90614
 * 0x5A、bmp180/ms5611 0xEE 全异——多挂合法），同选时经引脚绑定消解；
 * 与 hmc5883l 同为互替件（HMC 已停产，市售「HMC5883L 模块」多为本件——
 * 寄存器表不同、不可混用初始化序列，故各件独立且启动验 Chip ID） ---- */
#define QMC5883L_SCL_GPIO     GPIO_A
