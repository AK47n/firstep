...
**状态：** resolved——`.github/workflows/ci.yml` + `tests/test_ci_workflow.py`（6 例）；**线上全绿**（run `35098093620`，windows 全套 + ubuntu 快速面两个 job 都过）
...
- [x] 真机验证：等 GitHub 上这一轮的结论（红了就修配置，绿了才算成）
