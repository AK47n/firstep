# -*- coding: utf-8 -*-
"""joystick 编译矩阵：单选生成 → gmake 真编译（0 error 硬门槛）。"""
import sys
...
out = REPO / ".scratch" / "wiki-modules-batch1" / "matrix" / "joystick"
if out.exists():
    import shutil
    shutil.rmtree(out)
out.mkdir(parents=True)

resolved = resolve_selection(REPO / "library" / "modules", PLATFORM_MSPM0, ["joystick"])
generate(
