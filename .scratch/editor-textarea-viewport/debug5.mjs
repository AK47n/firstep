// 调试5：直接在页面上挂自定义 scroll 监听，验证滚动事件是否到达 #code-viewer
...
await Eval(`(() => {
  ...
  box.addEventListener('scroll', () => console.log('CUSTOM-SCROLL', box.scrollTop));
  console.log('SCROLLTOP-BEFORE', box.scrollTop);
  box.scrollTop = 60000;
  return true;
})()`);
