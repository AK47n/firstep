# -*- coding: utf-8 -*-
"""at24c02 编译矩阵：单选生成 → gmake 真编译（0 error 硬门槛）。"""
import sys
...
MAIN_C = (
    ...
    "(void)at24c02_write_page(16, page, AT24C02_PAGE_SIZE); "
    "at24c02_wait_write_done(); "
    "uint8_t buf[4] = {0}; (void)at24c02_read_block(16, buf, 4); while (1); }\n"
)

out = REPO / ".scratch" / "wiki-modules-batch5" / "matrix" / "at24c02"
if out.exists():
    import shutil
    shutil.rmtree(out)
out.mkdir(parents=True)

resolved = resolve_selection(REPO / "library" / "modules", PLATFORM_MSPM0, ["at24c02"])
generate(
