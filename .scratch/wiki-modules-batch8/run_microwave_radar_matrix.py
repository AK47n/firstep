# -*- coding: utf-8 -*-
"""microwave_radar 编译矩阵：单选生成 → gmake 真编译（0 error 硬门槛）。"""
import sys
...
MAIN_C = (
    ...
    "int main(void) { microwave_radar_init(); uint8_t d = microwave_radar_read(); "
    "(void)d; while (1); }\n"
)

out = REPO / ".scratch" / "wiki-modules-batch8" / "matrix" / "microwave_radar"
if out.exists():
    import shutil
    shutil.rmtree(out)
...
resolved = resolve_selection(
    REPO / "library" / "modules", PLATFORM_MSPM0, ["microwave_radar"]
)
generate(
