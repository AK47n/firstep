...
- 2026-08-15 合并复核（PR #76 squash merged c01517d，远端分支已删；主会话 diff 复核——10 处弱 handler B . → BX LR 恰 10 行指令 + 1 行注释、向量表/[WEAK]/Reset_Handler 零动、测试 4 条结构钉全对工单；合并后 main 复跑 1471 绿 28.2s = 1467 + 4 新）。
