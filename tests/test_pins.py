...
STM32_MACRO_VALUES = {
    ...
    # wiki-stm32-batch9/05：neo_6m GPS 定位（真实 UART + NMEA——UART_1=UWB 定位
    # 互替同脚；9600 运行期重配；RX 中断收帧——isr.c 聚合登记 neo_6m_rx_handler）
    "NEO_6M_UART": "UART_1",
    ...
    # wiki-stm32-batch8/06：ir_remote_tx 红外发射（gpio_out 默认 PA9——mspm0
    ...
    # wiki-stm32-batch2/06：ags10 有害气体（软 I2C 总线件——六件共总线 PA6/PA7
    # 收口；与 motor 电机方向重叠：有害气体传感与「带电机方向的小车运动控制」
    # 不同框；页面默认 SDA=PB8/SCL=PB9（=OLED 段）不采用；规格 ≤15kHz 与
    # 代码 100kHz 矛盾——按代码、真机异常调慢（唯一时序宏点））
    "AGS10_SCL_GPIO": "GPIO_A",
    "AGS10_SCL_PIN": "Pin_6",
    ...
    "HX711_DT_PIN": "Pin_0",
    # wiki-stm32-batch4/01：bmp180 气压（软 I2C 总线件——共总线 PA6/PA7；
    # 与 motor 电机方向重叠：气压/海拔与「带电机方向的小车运动控制」不同框；
    # 页面默认 SDA=PB9/SCL=PB8（=OLED 段）不采用；地址 0xEE 与既有 11 件
    # 全异、与 ms5611 同址 0xEE 互替不可同挂）
    "BMP180_SCL_GPIO": "GPIO_A",
...
MSPM0_DEFAULT_MAP = {
    ...
    ("zigbee_link", "ZIGBEE_UART_TX"): ("ZIGBEE_UART", "txPin"),
    ("zigbee_link", "ZIGBEE_UART_RX"): ("ZIGBEE_UART", "rxPin"),
    ("ir_beam", "IR_BEAM_OUT"): ("IR_BEAM", "OUT"),
    ("joystick", "JOYSTICK_SW"): ("JOYSTICK", "SW"),
    ("hc05", "HC05_TX"): ("HC05_UART", "txPin"),
    ("hc05", "HC05_RX"): ("HC05_UART", "rxPin"),
    ("hc05", "HC05_STATE"): ("HC05", "STATE"),
    ("hc05", "HC05_KEY"): ("HC05", "KEY"),
    ("nrf24l01", "NRF24L01_CLK"): ("NRF24L01", "CLK"),
    ("nrf24l01", "NRF24L01_MOSI"): ("NRF24L01", "MOSI"),
    ("nrf24l01", "NRF24L01_MISO"): ("NRF24L01", "MISO"),
    ("nrf24l01", "NRF24L01_CSN"): ("NRF24L01", "CSN"),
    ("nrf24l01", "NRF24L01_CE"): ("NRF24L01", "CE"),
    ("nrf24l01", "NRF24L01_IRQ"): ("NRF24L01", "IRQ"),
    ("ir_remote", "IR_REMOTE_OUT"): ("IR_REMOTE", "OUT"),
    ("max7219", "MAX7219_DIN"): ("MAX7219", "DIN"),
    ("max7219", "MAX7219_CLK"): ("MAX7219", "CLK"),
    ("max7219", "MAX7219_CS"): ("MAX7219", "CS"),
    ("lcd", "LCD_SCL"): ("LCD", "SCL"),
    ("lcd", "LCD_SDA"): ("LCD", "SDA"),
    ("lcd", "LCD_RES"): ("LCD", "RES"),
    ("lcd", "LCD_DC"): ("LCD", "DC"),
    ("lcd", "LCD_CS"): ("LCD", "CS"),
    ("lcd", "LCD_BLK"): ("LCD", "BLK"),
    ("tp_xpt2046", "TP_XPT2046_CS"): ("TP_XPT2046", "CS"),
    ("tp_xpt2046", "TP_XPT2046_CLK"): ("TP_XPT2046", "CLK"),
    ("tp_xpt2046", "TP_XPT2046_DIN"): ("TP_XPT2046", "DIN"),
    ("tp_xpt2046", "TP_XPT2046_DOUT"): ("TP_XPT2046", "DOUT"),
    ("tp_xpt2046", "TP_XPT2046_PEN"): ("TP_XPT2046", "PEN"),
    ("pca9685", "PCA9685_SCL"): ("PCA9685", "SCL"),
    ("pca9685", "PCA9685_SDA"): ("PCA9685", "SDA"),
    ("ir_remote_tx", "IR_TX_OUT"): ("IR_TX", "OUT"),
    ("jq8900", "JQ8900_TX"): ("JQ8900", "TX"),
    ("syn6288", "SYN6288_TX"): ("SYN6288", "TX"),
    ("rc522", "RC522_CS"): ("RC522", "CS"),
    ("rc522", "RC522_RST"): ("RC522", "RST"),
    ("rc522", "RC522_SCK"): ("RC522", "SCK"),
    ("rc522", "RC522_MOSI"): ("RC522", "MOSI"),
    ("rc522", "RC522_MISO"): ("RC522", "MISO"),
    ("fingerprint", "FINGERPRINT_TX"): ("FINGERPRINT_UART", "txPin"),
    ("fingerprint", "FINGERPRINT_RX"): ("FINGERPRINT_UART", "rxPin"),
    ("fingerprint", "FINGERPRINT_TOUCH"): ("FINGERPRINT", "TOUCH"),
    ...
    ("ads1115", "ADS1115_SCL"): ("ADS1115", "SCL"),
    ("ads1115", "ADS1115_SDA"): ("ADS1115", "SDA"),
    ("tcs34725", "TCS34725_SCL"): ("TCS34725", "SCL"),
    ("tcs34725", "TCS34725_SDA"): ("TCS34725", "SDA"),
    ("mlx90614", "MLX90614_SCL"): ("MLX90614", "SCL"),
    ("mlx90614", "MLX90614_SDA"): ("MLX90614", "SDA"),
    ...
    ("sht20", "SHT20_SCL"): ("SHT20", "SCL"),
    ("sht20", "SHT20_SDA"): ("SHT20", "SDA"),
    ("jy61p", "JY61P_SCL"): ("JY61P", "SCL"),
    ("jy61p", "JY61P_SDA"): ("JY61P", "SDA"),
    ("l298n", "L298N_PWM_C0"): ("L298N_PWM", "ccp0Pin"),
    ("l298n", "L298N_PWM_C1"): ("L298N_PWM", "ccp1Pin"),
    ...
    ("ms5611", "MS5611_SCL"): ("MS5611", "SCL"),
    ("ms5611", "MS5611_SDA"): ("MS5611", "SDA"),
    ...
    ("oled", "OLED_SPI_SCL"): ("OLED_SPI", "SCL"),
    ("oled", "OLED_SPI_SDA"): ("OLED_SPI", "SDA"),
    ("oled", "OLED_SPI_DC"): ("OLED_SPI", "DC"),
    ("oled", "OLED_SPI_CS"): ("OLED_SPI", "CS"),
    ("oled", "OLED_SPI_RES"): ("OLED_SPI", "RES"),
