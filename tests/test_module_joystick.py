...
实例（sequence 四通道——MEM1=PA26/A0_1、MEM2=PA25/A0_2；MEM3 归
ir_distance，wiki-modules-batch2/04），SW 独立 GPIO 输入（PA9）。
全程无 LLM、无服务。
"""
...
def test_joystick_mspm0_syscfg_instances():
    """mspm0 母版：JOYSTICK GPIO 实例（SW=PA9 上拉输入）+ ADC12_0 四通道
