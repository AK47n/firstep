...
- 分类：传感器类
- 来源：https://wiki.lckfb.com/zh-hans/dmx/module/sensor/mq-4-sensor.html
- 标题：MQ-4甲烷检测传感器
- 代码块：3 个 · 图片：0 张

MQ-4气体传感器所使用的气敏材料是在清洁空气中电导率较低的二氧化锡(SnO2)。当传感器所处环境中存在燃料气体时，传感器的电导率随空气中可燃气体浓度的增加而增大。使用简单的电路即可将电导率的变化转换为与该气体浓度相对应的输出信号。MQ-4气体传感器中对甲烷的灵敏度高，对丙烷，丁烷也有较好的灵敏度。这种传感器可检测多种可燃性气体，特别是天然气，是一款适合多种应用的低成本传感器

## 一、模块来源

采购链接：

[MQ-4天然气传感器模块甲烷丙烷丁烷液化石油气可燃性气体监测模块](https://detail.tmall.com/item.htm?abbucket=0&id=696222346171&ns=1&spm=a21n57.1.0.0.5668523c1NVcMb)
...
移植步骤中的导入.c和.h文件与**传感器章节**的【**DHT11温湿度传感器**】相同，只是将.c和.h文件更改为**bsp_mq4.c**与**bsp_mq4.h**。这里不再过多讲述，移植完成后面修改相关代码。

在文件**bsp_mq4.c**中，编写如下代码。
 ...
 * 备       注：无
******************************************************************/
unsigned int Get_Adc_MQ4_Value(void)
{
      uint32_t Data = 0;
 ...
 * 备       注：无
******************************************************************/
unsigned int Get_MQ4_Percentage_value(void)
{
      int adc_max = 4095;
      int adc_new = 0;
...
/******************************************************************
 * 函 数 名 称：Get_MQ4_DO_value
 * 函 数 说 明：获取MQ4DO引脚的电平状态
 * 函 数 形 参：无
 * 函 数 返 回：0=未检测到高于灵敏度的酒精值 1=检测到高于灵敏度的酒精值
 * 作       者：LC
 * 备       注：调整模块上的滑动电阻即可调整灵敏度
******************************************************************/
char Get_MQ4_DO_value(void)
{
      if( MQ_DO == 0 )
      {
            return 0;
...
> **【百度网盘】**：**链接**：[https://pan.baidu.com/s/1n8hYw9Oyf_6J-aK26LSzuw?pwd=za8j](https://pan.baidu.com/s/1n8hYw9Oyf_6J-aK26LSzuw?pwd=za8j)**提取码**：za8j

## 百度网盘下载

- https://pan.baidu.com/s/1B8WhPIzTmWwQsFFVayRpAA?pwd=9966
- https://pan.baidu.com/s/1n8hYw9Oyf_6J-aK26LSzuw?pwd=za8j
