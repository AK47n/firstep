...
- 分类：传感器类
- 来源：https://wiki.lckfb.com/zh-hans/dmx/module/sensor/mq-8-sensor.html
- 标题：MQ-8氢气检测传感器
- 代码块：3 个 · 图片：0 张
...
[MQ-8氢气传感器检测报警模块　气体传感器模块](https://item.taobao.com/item.htm?spm=a21n57.1.0.0.5668523c1NVcMb&id=36125146305&ns=1&abbucket=0#detail)
...
移植步骤中的导入.c和.h文件与**传感器章节**的【**DHT11温湿度传感器**】相同，只是将.c和.h文件更改为**bsp_mq8.c**与**bsp_mq8.h**。这里不再过多讲述，移植完成后面修改相关代码。

在文件**bsp_mq8.c**中，编写如下代码。
 ...
 * 备       注：无
******************************************************************/
unsigned int Get_Adc_MQ8_Value(void)
{
      uint32_t Data = 0;
...
/******************************************************************
 * 函 数 名 称：Get_MQ8_DO_value
 * 函 数 说 明：获取MQ8DO引脚的电平状态
 * 函 数 形 参：无
...
> **【百度网盘】**：**链接**：[https://pan.baidu.com/s/11I33nBFpygcLNb9XM4nWIQ?pwd=kpr3](https://pan.baidu.com/s/11I33nBFpygcLNb9XM4nWIQ?pwd=kpr3)**提取码**：kpr3

## 百度网盘下载

- https://pan.baidu.com/s/1B8WhPIzTmWwQsFFVayRpAA?pwd=9966
- https://pan.baidu.com/s/11I33nBFpygcLNb9XM4nWIQ?pwd=kpr3
