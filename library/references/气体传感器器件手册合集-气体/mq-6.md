...
- 分类：传感器类
- 来源：https://wiki.lckfb.com/zh-hans/dmx/module/sensor/mq-6-sensor.html
- 标题：MQ-6丙烷检测传感器
- 代码块：3 个 · 图片：0 张
...
[MQ-6 丙烷 液化气 检测模块 可燃气体传感器模块](https://detail.tmall.com/item.htm?abbucket=0&id=695356135146&ns=1&spm=a21n57.1.0.0.5668523c1NVcMb)
...
1. 然后我们所有设定的引脚和功能就会在 **ti_msp_dl_config.h** 中定义。因为这个文件我们包含进了 **board.h** 所以我们只需要引用 **board.h** 即可。【这里的 **board.h** 就充当了芯片头文件的作用】

移植步骤中的导入.c和.h文件与**传感器章节**的【**DHT11温湿度传感器**】相同，只是将.c和.h文件更改为**bsp_mq6.c**与**bsp_mq6.h**。这里不再过多讲述，移植完成后面修改相关代码。

在文件**bsp_mq6.c**中，编写如下代码。
...
/******************************************************************
 * 函 数 名 称：Get_MQ6_DO_value
 * 函 数 说 明：获取MQ6DO引脚的电平状态
 * 函 数 形 参：无
...
> **【百度网盘】**：**链接**：[https://pan.baidu.com/s/1__HTGRmlCbF24DRAgl0KTg?pwd=jgu3](https://pan.baidu.com/s/1__HTGRmlCbF24DRAgl0KTg?pwd=jgu3)**提取码**：jgu3

## 百度网盘下载

- https://pan.baidu.com/s/1B8WhPIzTmWwQsFFVayRpAA?pwd=9966
- https://pan.baidu.com/s/1__HTGRmlCbF24DRAgl0KTg?pwd=jgu3
