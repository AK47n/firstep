...
- 分类：传感器类
- 来源：https://wiki.lckfb.com/zh-hans/dmx/module/sensor/mq-7-sensor.html
- 标题：MQ-7一氧化碳检测传感器
- 代码块：3 个 · 图片：0 张

MQ-7气体传感器所使用的气敏材料是在清洁空气中电导率较低的二氧化锡(SnO)。采用高低温循环检测方式低温（1.5V加热）检测一氧化碳，传感器的电导率随空气中一氧化碳气体浓度增加而增大,高温（5.0V加热）清洗低温时吸附的气体。使用简单的电路即可将电导率的变化转换为与该气体浓度相对应的输出信号。

## 一、模块来源

采购链接：

[MQ-7 一氧化碳传感器模块 气敏传感器检测报警模块](https://detail.tmall.com/item.htm?abbucket=0&id=13673403530&ns=1&spm=a21n57.1.0.0.5668523c1NVcMb)
...
本品在较宽的浓度范围内对一氧化碳有良好的灵敏度，具有长寿命、低成本、驱动电路简单等优点.
...
移植步骤中的导入.c和.h文件与**传感器章节**的【**DHT11温湿度传感器**】相同，只是将.c和.h文件更改为**bsp_mq7.c**与**bsp_mq7.h**。这里不再过多讲述，移植完成后面修改相关代码。

在文件**bsp_mq7.c**中，编写如下代码。
...
> **【百度网盘】**：**链接**：[https://pan.baidu.com/s/1PUEsbO8ZdNNtxIfaUp4H0g?pwd=m2y4](https://pan.baidu.com/s/1PUEsbO8ZdNNtxIfaUp4H0g?pwd=m2y4)**提取码**：m2y4

## 百度网盘下载

- https://pan.baidu.com/s/1B8WhPIzTmWwQsFFVayRpAA?pwd=9966
- https://pan.baidu.com/s/1PUEsbO8ZdNNtxIfaUp4H0g?pwd=m2y4
