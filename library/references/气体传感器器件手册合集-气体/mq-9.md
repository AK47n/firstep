...
- 分类：传感器类
- 来源：https://wiki.lckfb.com/zh-hans/dmx/module/sensor/mq-9-sensor.html
- 标题：MQ-9可燃气体检测传感器
- 代码块：3 个 · 图片：0 张
...
[模块 MQ-9一氧化碳　可燃气体传感器检测报警模块](https://item.taobao.com/item.htm?id=17191853047&spm=a1z10.3-c.w4002-14787471870.9.386f6865jOIMiG)
...
移植步骤中的导入.c和.h文件与**传感器章节**的【**DHT11温湿度传感器**】相同，只是将.c和.h文件更改为**bsp_mq9.c**与**bsp_mq9.h**。这里不再过多讲述，移植完成后面修改相关代码。

在文件**bsp_mq9.c**中，编写如下代码。
...
/******************************************************************
 * 函 数 名 称：Get_MQ9_DO_value
 * 函 数 说 明：获取MQ9DO引脚的电平状态
 * 函 数 形 参：无
 * 函 数 返 回：0=未检测到高于灵敏度的酒精值 1=检测到高于灵敏度的酒精值
 * 作       者：LC
 * 备       注：调整模块上的滑动电阻即可调整灵敏度
******************************************************************/
char Get_MQ9_DO_value(void)
{
      if( MQ_DO == 0 )
      {
            return 0;
...
> **【百度网盘】**：**链接**：[https://pan.baidu.com/s/1oEguSddIoC8ylQPQ55EKVA?pwd=9k5m](https://pan.baidu.com/s/1oEguSddIoC8ylQPQ55EKVA?pwd=9k5m)**提取码**：9k5m

## 百度网盘下载

- https://pan.baidu.com/s/1B8WhPIzTmWwQsFFVayRpAA?pwd=9966
- https://pan.baidu.com/s/1oEguSddIoC8ylQPQ55EKVA?pwd=9k5m
