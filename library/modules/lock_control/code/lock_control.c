...
{
    gpio_init(LED_PORT, LED_RED_PIN, OUT_PP);
    gpio_init(LED_PORT, LED_YELLOW_PIN, OUT_PP);
    gpio_init(LED_PORT, LED_GREEN_PIN, OUT_PP);
...
{
    gpio_set(LED_PORT, LED_RED_PIN,   red    ? 1 : 0);
    gpio_set(LED_PORT, LED_YELLOW_PIN, yellow ? 1 : 0);
    gpio_set(LED_PORT, LED_GREEN_PIN,  green  ? 1 : 0);
}
