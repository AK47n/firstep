...
#include "ti_msp_dl_config.h" /* TP_XPT2046_<引脚名>_PORT/_PIN（SysConfig 生成） */
#include "delay.h"
...
#define TP_DOUT() DL_GPIO_readPins(TP_XPT2046_DOUT_PORT, TP_XPT2046_DOUT_PIN)
#define TP_PEN()  DL_GPIO_readPins(TP_XPT2046_PEN_PORT, TP_XPT2046_PEN_PIN)
...
void xpt2046_init(void)
{
     ...
     * 128×160；四方向预设见 tp_xpt2046.h 注释，换屏/方向自设校准） */
    s_xfac = 0.034810f;
    s_xoff = -5;
    s_yfac = 0.043057f;
    s_yoff = -7;
...
/* 向 XPT2046 写 1 字节（MSB 先；TCLK 上升沿有效——vendor TP_Write_Byte） */
