 ...
 *   （wiki-modules-batch8：**MEM 槽位已满（8/8）**——后续 ADC 类件一律薄封装
 *   共读 MEM0，mq2/us016 先例：多件同选同读一物理通道）。
...
typedef enum
{
    ...
    ADC_Channel_6, /* MEM6（PA22 / A0_7——归 flame 火焰传感，独立通道；
                    * wiki-modules-batch8/01） */
    ADC_Channel_7, /* MEM7（PA14 / A0_12——归 soil 土壤湿度，独立通道；
                    * wiki-modules-batch8/02；**MEM 槽位已满（8/8）**） */
    ADC_Channel_8,
    ADC_Channel_9,
    ADC_Channel_10,
    ADC_Channel_11,
