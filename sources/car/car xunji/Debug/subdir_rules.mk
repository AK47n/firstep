...
%.o: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs2051/ti_cgt_arm_llvm_4.0.2.LTS/bin/tiarmclang.exe" -c @"device.opt"  -march=thumbv6m -mcpu=cortex-m0plus -mfloat-abi=soft -mlittle-endian -mthumb -O0 -I"C:/Users/luoji/Desktop/car xunji" -I"C:/Users/luoji/Desktop/car xunji/USART_JY61P" -I"C:/Users/luoji/Desktop/car xunji/Debug" -I"C:/ti/ccs2051/mspm0_sdk_2_10_00_04/source/third_party/CMSIS/Core/Include" -I"C:/ti/ccs2051/mspm0_sdk_2_10_00_04/source" -D__MSPM0G3507__ -gdwarf-3 -MMD -MP -MF"$(basename $(<F)).d_raw" -MT"$(@)"  $(GEN_OPTS__FLAG) -o"$@" "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

build-474970721: ../empty.syscfg
	@echo 'SysConfig - building file: "$<"'
	"C:/ti/ccs2051/sysconfig_1.26.2/sysconfig_cli.bat" -s "C:/ti/ccs2051/mspm0_sdk_2_10_00_04/.metadata/product.json" --script "C:/Users/luoji/Desktop/car xunji/empty.syscfg" -o "." --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '
