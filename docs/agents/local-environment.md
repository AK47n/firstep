...
| 版本 | 线上状态 | 说明 |
|---|---|---|
| **v1.2.0（2026-09-14 重发）** | ✅ 已重发：**旧那版 Release + tag 已删**，同一版号重打两包重传（完整包 `807,703,710` B / 小发版 `310,583,723` B），线上 tag 指向 `83ad3b01` | 重发原因 = 完整包解压报「路径太长」（第 6 节）。版本号**没动**（用户指定沿用 v1.2.0） |
